...
and Regression section. Under Exploration you can view first descriptive results for the selected country. 
In the Regression area, a linear regression model is calculated for your selected outcome.
...
The regression area allows you to add additional control variables. For example, gender 
and educational level can be added. The age variable can also be modified. Once the parameters 
are set, the formula used to calculate the regression is displayed. The coefficients of the 
regression are displayed and the predicted values can be evaluated with the residual plot.
