...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{logcount =} \KeywordTok{ifelse}\NormalTok{(logcount }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, }\OperatorTok{-}\OtherTok{Inf}\NormalTok{, logcount)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{logcount =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(logcount) }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{ , }\DecValTok{0}\NormalTok{, logcount)) }\OperatorTok{%>%}\StringTok{ }
...
\includegraphics{../output/Analytical_Notebook_Stefan_Zimmermann_files/figure-latex/unnamed-chunk-5-2.pdf}
...
\StringTok{  }\KeywordTok{ml_linear_regression}\NormalTok{(logcount }\OperatorTok{~}\StringTok{ }\NormalTok{Country_Region }\OperatorTok{+}\StringTok{ }\NormalTok{Population }\OperatorTok{+}\StringTok{ }\NormalTok{datecount) }\OperatorTok{%>%}\StringTok{   }
